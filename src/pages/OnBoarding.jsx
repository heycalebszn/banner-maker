...
const OnBoarding = () => {
    return(
        <div className="flex flex-col items-center justify-center text-center pt-[200px] relative">
            ...
            <h1 className="md:text-[70px] text-white text-[40px]">Get your customized Social banner.</h1>
            <p className="md:text-[50px] text-transparent text-white font-800 text-[35px]">for Software Developers & Designers.</p>
            </div>
            ...
            <div>
                <img className="rounded-[50px] mt-[100px] w-[1000px] md:px-[0px] px-[20px]" src={David} alt="david" />
